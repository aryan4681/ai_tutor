...
def main():
    ...
    if st.session_state.app_state == 'welcome':
        # Simplified header - remove redundant welcome message
        
        # Create columns for the welcome page with gamification stats
        ...
        with col2:
            ...
            st.subheader("Subject & Topic Selection")
            if subject_chosen:
        ...
        with col3:
            # Remove the "Study Plan" subheader
            if st.button("Create Study Plan", key="create_study_plan_btn", type="primary"):
                st.session_state.app_state = 'study_plan_setup'
                st.rerun()
                
            # Show existing study plan without the "Study plan available" message
            if st.session_state.study_plan:
                if st.button("View Plan", key="view_study_plan_btn"):
